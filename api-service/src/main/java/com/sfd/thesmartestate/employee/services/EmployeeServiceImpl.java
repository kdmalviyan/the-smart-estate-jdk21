...
import com.sfd.thesmartestate.employee.EmployeeHelper;
...
import com.sfd.thesmartestate.employee.exceptions.UserManagementException;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    public List<Employee> getEmployeeByNameStartsWithAndProjectName(String name, String projectName) {
    ...
    public void sendForgotPasswordOTP(String emailUsername) {
        ...
        NotificationMessage notificationMessage = employeeHelper.createPasswordChangeOTPEmailMessage(employee);
    ...
    public Employee resetPassword(ResetPasswordRequestPayload requestPayload) {
        employeeHelper.validateResetRequest(requestPayload);
        Employee employee = getValidUser(requestPayload.getUsername());
        OneTimePassword otp = employeeHelper.validateOTP(employee, requestPayload.getOtp());
